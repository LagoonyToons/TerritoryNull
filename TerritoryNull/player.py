...
class Player():
    def __init__(self, playerList):
        ...
        self.top_piece = rocketPiece(playerList[0][3], "top", SCREEN_X/2, SCREEN_Y/2, self.topw, self.toph)
        self.mid_piece = rocketPiece(playerList[1][3], "middle", self.midx, self.midy, self.midw, self.midh, self.toph, self.midh)
        self.bot_piece = rocketPiece(playerList[2][3], "bottom", self.botx, self.boty, self.botw, self.both, self.toph, self.midh)
